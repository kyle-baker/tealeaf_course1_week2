...
# 2. Write out a description of the program. Extract nouns from description, and group common verbs into
# nouns.
# 
# What is a Tic Tac Toe game?
# Two player game, start with empty 3x3 board. One player designated 'X' other 'O'. Two players alternate turns 
# marking an empty space until one player achieves three in a row or no more spaces are available. In case of latter
# game is a tie.
